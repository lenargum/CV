...
export default function QRCode({ profile }: { profile: ProfileType }) {
    ...
    return (
        <a className="hidden print:flex justify-center items-center" href={`https://lenargum.me/${currentLang}/${profile}/`} target="_blank" rel="noopener noreferrer" title="Open CV in browser">
